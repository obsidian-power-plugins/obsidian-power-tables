...
for (const vault of vaults) {
	...
	const dest = join(vault, ".obsidian", "plugins", "powertables");
...
console.log(deployed ? `Done. Reload Obsidian (Ctrl+R) and enable "Power Tables" if it isn't enabled yet.` : "Nothing deployed.");
